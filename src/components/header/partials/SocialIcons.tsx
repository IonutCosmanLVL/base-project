    ...
    return (
        <div className={`flex gap-4 items-center text-${color} ${className}`}>
            {[
                ...
                svg: (
                     <svg width="24px" height="24px" viewBox="-5 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                svg: (
                    <svg fill="currentColor" width="24px" height="24px" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
