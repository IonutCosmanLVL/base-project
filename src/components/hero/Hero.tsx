...
export default async function HeroWrapper() {
    ...
    if (!heroData) return <div className="text-red-500">⚠️ No hero data</div>;
            ...
            <div className="relative z-20 flex h-full px-6 flex-col justify-center items-center text-center lg:flex-row lg:items-center lg:justify-start lg:text-left">
                <div className="w-full max-w-[1440px] mx-auto">
                    <div className="w-full lg:w-1/2 text-shadow-sm flex flex-col items-center justify-center text-center lg:items-start lg:justify-start lg:text-left space-y-[100px] mt-[120px]">
                        <Headline staticTitle={staticTitle} animatedPhrases={animatedPhrases} />
...
// This HeroWrapper component fetches the hero data from Contentful and renders the hero section.
// It includes a background image, a black overlay, and the main content with a headline,